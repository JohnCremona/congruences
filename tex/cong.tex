...
that the strong form of the 
Frey--Mazur conjecture with~$C=18$ holds for the congruences available in the LMFDB database. We refer to~\cite{Halberstadt-Kraus-FreyMazur} for a theoretical result towards this very challeging conjecture.
