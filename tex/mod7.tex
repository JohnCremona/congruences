...
the subsets found in Step~1 is $\{{\tt 25921a1}, {\tt 78400gw1}, {\tt
336973z1}, {\tt 336973ba1}\}$; however, curve {\tt 25921a1} is not
in fact $\mod{7}$-isomorphic to the other three, while $\{{\tt
  78400gw1}, {\tt 336973z1}, {\tt 336973ba1}\}$ is a genuine triple
of curves which have mutually isomorphic $\mod{7}$-representations.

This false postive arose since {\tt 25921a1} and {\tt 78400gw1}
have $a_{\ell}$ which are congruent modulo~$7$ for
all~$\ell\in\calL_{30}$.  In this case, using $\calL_{40}$ instead
...
are irreducible ({\it i.e.,} conssist of curves whose
...
irreducible as $G_{\Q}$-module, and wish to determine whether this is
a symplectic or anti-symplectic triple.  For all odd~$p$ we apply the
local criteria of \cite{FKsyn}, while for $p=7$ we use the modular
parametrizations and explicit formulae of Kraus and Halberstad,
Poonen, Schaefer and Stoll, as extended and completed by Fisher in 
  \cite{Fisher}.
