...
\item For one curve~$E$ in each isogeny class we computed the set
  $M_E$ from the conductor and minimal discriminant.  We found that
  the largest prime~$p$ occurring in any~$M_E$ was~$97$: in fact,
  ...
  Section~\ref{S:statistics}, there are no congruences for $19\le
  p\le97$.
\end{enumerate}
