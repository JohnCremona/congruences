...
\subsection{Twists of mod~$p$ Galois representations}
We now consider the effect of twists on mod~$p$ Galois
representations.  This is straihtforward in the case of quadratic
...
When $n=4$, the case $d=2$ is only possible in the case of the special
quartic twist by~$-4$.
...
pairing, therefore the symplectic type of the congruence $E[p] \simeq
E'[p]$ is determined by the square class of $\det M$.
...
automorphisms, \textit{i.e.}, they satisfy condition~{\bf (S)} of the
introduction.
...
that~$E[p]$ satisfies condition~{\bf (S)}.
