...
\emph{~$E[p]$ satisfies condition~{\bf (S)}} if $E[p]$ does not admit
...
Kraus in~\cite{FKSym}.\jc{Do you want to add ``over $\Q$'' here?}
...
One way to circumvent this computational problem, at last over~$\Q$, is to use the methods
...
\begin{lemma}\label{L:twist-rep}
  \begin{enumerate}
    \item
  Let $E$ and $E^d$ be quadratic twists defined over~$K$.  Then
