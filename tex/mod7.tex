...
Moreover, when the sextic twist is actually a cubic twist then we have $\PP\rhobar_{E,p}(G_K) \simeq D_3$ while for a genunine sextic twist both cases can occur.
\end{lemma}
...
Fix basis for $E[p]$ and~$E'[p]$ as above so that the matrix equality \eqref{E:PsiMatrix} holds. Then 
